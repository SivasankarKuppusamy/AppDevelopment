      ...
      {isSidebarOpen ? (
          ...
          {userType=="admin"?(
            <>
              ...
              <MenuItem  style={{ backgroundColor: activeMenuItem === 'Subjects' ? 'rgb(51, 51, 241)' : 'transparent',borderRadius:50}} component={<Link to="/subjects" />} icon={<SubjectIcon />} onClick={() => handleMenuItemClick('Subjects')}>Subjects</MenuItem>
              ...
              <MenuItem  style={{ color: activeMenuItem === 'Subjects' ? 'rgb(51, 51, 241)' : 'black',borderRadius:50}} component={<Link to="/subjects" />} icon={<SubjectIcon />} onClick={() => handleMenuItemClick('Subjects')}></MenuItem>
              <MenuItem  style={{ color: activeMenuItem === 'Reports' ? 'rgb(51, 51, 241)' : 'black',borderRadius:50}} component={<Link to="/reports" />} icon={<ImportContactsIcon />} onClick={() => handleMenuItemClick('Reports')}></MenuItem>
              <MenuItem onClick={handleLogout} icon={<LogoutIcon />} className="menu-item-l">Logout</MenuItem>
