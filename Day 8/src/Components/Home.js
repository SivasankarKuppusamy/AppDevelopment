...
function Home() {
 ...
 <br></br> <button class="btn1">COURSES</button>
...
<div class="footer-bottom">
  Copyright &copy;  Miniature and Companies 2023.<u class="u1"><Link to="/terms">Terms and Conditons</Link> </u><u class="u2"><Link to="/privacy">Privacy Policy</Link></u>
</div>
</div>
    </div>
  )
